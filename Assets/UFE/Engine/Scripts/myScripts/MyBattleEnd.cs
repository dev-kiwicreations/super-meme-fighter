    ...
    public class MyBattleEnd : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            else
            {
                ...
                Debug.Log("Winner is null and name is: |" + UFE.WinCheck
                ...
                if (UFE.Mode == 1)
                {
                    APIReader.Instance.PutAPIRequest(winCondition, "meme");
                    UFE.WinCheck = winCondition;
                    Debug.Log("WinCheck = " + UFE.WinCheck);
                }
