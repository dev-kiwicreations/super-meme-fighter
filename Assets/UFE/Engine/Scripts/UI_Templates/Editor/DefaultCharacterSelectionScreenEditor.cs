...
public class DefaultCharacterSelectionScreenEditor : Editor{
	public override void OnInspectorGUI (){
        ...
        EditorGUILayout.PropertyField(this.serializedObject.FindProperty("selectButton"));

        EditorGUILayout.PropertyField(this.serializedObject.FindProperty("title1"));
        EditorGUILayout.PropertyField(this.serializedObject.FindProperty("title2"));

        EditorGUILayout.PropertyField(this.serializedObject.FindProperty("hudOffset"));
